...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2022 at 10:20 AM
...
(54, 33, 'Chicken Biriyani', 10, '100.00', 'Evening', '10am', '10pm', '2022-02-20', 'Party', NULL, '2022-02-16 17:02:20');
...
--
ALTER TABLE `users_orders`
  MODIFY `o_id` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
COMMIT;
