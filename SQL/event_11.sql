...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2022 at 06:04 PM
...
(5, 'Waiter', 'karim', 'Robiul', 'Karim', 'karim@gmail.com', '25d55ad283aa400af464c76d713c07ad', '01638575578', 'Ibrahim mension,K.B Aman Ali Road,Chawkbazar,Chittagong');
...
--
-- Table structure for table `de_ser`
--

CREATE TABLE `de_ser` (
  `ds_id` int(222) NOT NULL,
  `dc_id` int(222) NOT NULL,
  `ds_name` varchar(222) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ds_details` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `dealer`
  MODIFY `de_id` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `dealer_cat`
--
ALTER TABLE `dealer_cat`
  MODIFY `dc_id` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `de_ser`
--
ALTER TABLE `de_ser`
  MODIFY `ds_id` int(222) NOT NULL AUTO_INCREMENT;
