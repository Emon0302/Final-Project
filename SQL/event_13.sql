...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2022 at 04:21 PM
...
INSERT INTO `admin_order` (`o_id`, `de_id`, `username`, `quantity`, `price`, `shift`, `o_hr`, `c_hr`, `edate`, `type`, `status`, `date`) VALUES
(1, 4, 'assdasda', 40, '123', 'asdasd', 'asdasdas', 'asdasdasd', '2022-03-01', 'assdasda', 'asdasd', '2022-03-22 13:42:52');
...
--
ALTER TABLE `dealer_cat`
  MODIFY `dc_id` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
