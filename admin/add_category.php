...
if(isset($_POST['submit'] ))
{
	...
	$check_cat= mysqli_query($db, "SELECT c_name FROM ser_category where c_name = '".$_POST['c_name']."' ");
	...
	$mql = "INSERT INTO ser_category(c_name) VALUES('".$_POST['c_name']."')";
	mysqli_query($db, $mql);
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM ser_category order by c_id desc";
